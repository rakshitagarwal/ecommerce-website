...
<html lang="en">
<head>
<title>LetsShop-The Online Store</title>
<meta charset="utf-8">
		...
		<div class="container">
			...
			<nav class="my-nav navbar navbar-inverse bs-dark">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="ioo">LetsShop</a> <a
						class="navbar-brand" rel="home" href="ioo" title="Fantezy"> <img
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="displayProducts"><span class="glyphicon glyphicon-list"></span>Products</a></li>
